...
' variable to keep track of opening price for each specific year
Dim opening_price As Double

' variable to keep track of closing price for each specific year
Dim closing_price As Double

' variable to keep track of each year's change
...
' variable to keep track of greatest percent increase value for each specific year.
Dim greatest_percent_increase As Double

' variable to keep track of the ticker that has the greatest overall percent increase.
Dim greatest_percent_increase_ticker As String

' varible to keep track of the greatest overall percent decrease value for specific year.
Dim greatest_percent_decrease As Double

' variable to keep track of the ticker that has the greatest overall percent decrease.
Dim greatest_percent_decrease_ticker As String

' variable to keep track of the greatest stock volume value for each specific year.
Dim greatest_stock_volume As Double

' variable to keep track of the ticker that has the greatest overall stock volume.
...
For Each ws In Worksheets
    ...
    For i = 2 To lastRowState
        ...
        ' Find the ticker with the greatest overall percent increase.
        ...
        ' Find the ticker with the greatest overall percent decrease.
        ...
        ' Find the ticker with the greatest overall stock volume.
    ...
    ' Add the values for greatest overall percent increase, decrease, and stock volume to each worksheet.
...
' checked my work against a solution i found online via philipstubbs13 and fooled around with the end result a tiny bit.
' I had a bunch correct and what wasn't working for me I was able to work backwards from this source to figure it out.
